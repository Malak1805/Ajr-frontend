 ...
 <div className="about-container">
        ...
        <div className="about-content">
          ...
          <div className="features-section">
            <h2 className="section-heading slide-in-left">💡 What Sets Us Apart</h2>
          ...
          <div className="vision-mission-section">
            <h2 className="section-heading slide-in-right">🌍 Our Vision</h2>
          ...
          <div className="vision-mission-section">
            <h2 className="section-heading slide-in-left">🤝 Our Mission</h2>
